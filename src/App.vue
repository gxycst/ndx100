  ...
  <div id="app">
   <h1 style="text-align: center">{{ type }}</h1>
    ...
    <footer class="page-footer">
      ...
      <p class="footer-text">
        “Desire is the oracle of our fate.” — Friedrich Schiller
      </p>
    </footer>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      typeList:[
          'ndx','spy','n225','topix','csi300','csi500','gold'
      ],
      type: 'ndx'
    }
  },
...
body::-webkit-scrollbar-track {
  background: rgba(0, 0, 0, 0.05); /* 浅灰透明轨道 */
  border-radius: 10px;
}

/* 滚动条滑块（Thumb） */
body::-webkit-scrollbar-thumb {
  background: linear-gradient(180deg, #e60000, #ff4d4d); /* A股红渐变 */
  border-radius: 10px;

  /* 轻光泽，专业感 */
  box-shadow: 0 0 4px rgba(230, 0, 0, 0.35);
}
